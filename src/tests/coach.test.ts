...
describe("CoachModel", () => {
  ...
  describe("Constructor and Properties", () => {
    test("should create coach with all required properties", () => {
      ...
      expect(coach.specialization).toEqual(["psychology", "therapy", "mental-health"])
      expect(coach.bio).toBe("Experienced psychologist with 10 years of practice in cognitive behavioral therapy")
      ...
      expect(coach.tags).toEqual(["psychology", "therapy", "cbt", "anxiety", "depression"])
    })
  ...
  describe("Edge Cases and Error Handling", () => {
    ...
    test("should handle coach with empty specialization array", () => {
      ...
      expect(coachWithNoSpecialization.matchesSpecialization("psychology")).toBe(false)
    })
