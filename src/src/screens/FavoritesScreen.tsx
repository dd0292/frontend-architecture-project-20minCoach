...
const FavoritesScreen: React.FC = () => {
    ...
    <View style={styles.coachCard}>
      ...
      >
        ...
        <View style={styles.coachInfo}>
          <Typography variant="body" color={theme.colors.text} style={{ fontWeight: "bold", marginBottom: 2 }}>
            {item.name}
          </Typography>
          ...
          <RatingDisplay rating={item.rating} reviewCount={item.reviewCount} size="small" />

          <View style={styles.availabilityContainer}>
            <StatusDot status={item.isAvailable} />
            <Typography variant="caption" color={theme.colors.textSecondary} style={styles.statusText}>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <NavigationHeader title="Favorite Coaches" showBackButton onBackPress={() => navigation.goBack()} />
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Typography variant="h3" color={theme.colors.text} style={styles.emptyStateTitle}>
              No Favorites Yet
            </Typography>
