...
const CoachListingScreen: React.FC = () => {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.searchSection, { backgroundColor: theme.colors.surface, borderBottomColor: theme.colors.border }]}>
        <SearchBar
          value={searchQuery}
        ...
        <View style={styles.filterRow}>
          <TouchableOpacity style={[styles.filterButton, { backgroundColor: theme.colors.primary + "20" }]}>
            <Ionicons name="funnel" size={16} color={theme.colors.primary} />
            <Typography variant="caption" color={theme.colors.primary} style={styles.filterText}>
              Filters
            </Typography>
          </TouchableOpacity>

          <TouchableOpacity style={styles.sortButton}>
            <Typography variant="caption" color={theme.colors.textSecondary} style={styles.sortText}>
              Sort: Rating
            </Typography>
