...
const SessionHistoryScreen: React.FC = () => {
    ...
    return (
      <View style={styles.sessionCard}>
        ...
        <View style={styles.sessionContent}>
          <Typography variant="body" color={theme.colors.text} style={{ fontWeight: "600", marginBottom: 4 }}>
            Problem:
          </Typography>
          <Typography variant="body" color={theme.colors.textSecondary} style={styles.problemText}>
            {item.problem}
          </Typography>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <NavigationHeader title="Session History" showBackButton onBackPress={() => navigation.goBack()} />
